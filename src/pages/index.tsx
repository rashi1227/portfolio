    ...
    <>
      ...
      <NextSeo
        ...
        openGraph={{
          ...
          title: "Rashi Aggarwal - React and Frontend Developer Portfolio",
          description:
            "Dive into the world of web development with Rashi. React and Frontend Developer, showcasing cutting-edge projects and a commitment to crafting exceptional user interfaces.",
          images: [
            {
