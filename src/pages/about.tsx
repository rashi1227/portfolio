    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          title: "Learn About Rashi Aggarwal - React and Frontend Developer",
          description:
            "Dive into the story of Rashi Aggarwal, a React and Frontend Developer. Uncover the experiences, skills, and passion that fuel a commitment to delivering exceptional web solutions.",
          images: [
            {
        ...
        <div className="sm:1/2 mt-10 w-full lg:w-1/2">
          <AnimatePresence>
            <FadeUp key="title-greeting" duration={0.6}>
              <h1 className="bg-gradient-to-r from-teal-500 to-tera-500 bg-clip-text text-6xl font-bold text-transparent dark:from-teal-200 dark:to-teal-500 sm:text-7xl md:text-6xl lg:text-5xl xl:text-7xl pb-2">
                Hi, I&apos;m Rashi Aggarwal
              </h1>
            </FadeUp>
            ...
            <FadeUp key="description-2" duration={0.6} delay={0.4}>
              <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
                ...
                Nextjs, Javascript and web development.
              </p>
            </FadeUp>
            <FadeRight
              key="hero-location"
